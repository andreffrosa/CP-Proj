...
\subsubsection{Scan}
The parallel version of the Scan pattern shows an improvement in terms of latency when compared to its sequential counterpart as seen in Figure~\ref{latency}. 
