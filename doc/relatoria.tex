...
%, for that it takes in consideration the size, and number of the elements to process.
We tried to make the batching separation ourselfs, however, because we were getting poorer outcomes, and because we couldn't make assumptions on data types we were manipulating, and thus not know its size, we decided make use of Cilk$^+$'s automatic splitting.
