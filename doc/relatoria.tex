...
Nowadays, the parallel paradigm is a matter of great importance. Every day the amount of data to be
processed grows [meter uma citação], as well as the demand for efficient programs that produce results faster and efficiently.
