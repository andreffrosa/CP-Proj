...
\subsection{Map}
The map pattern represents the independent application of a function to every element of a collection, and thus each operation can be parallelized. [Dizer mais o que?]
...
[isto secalhar vai para a parte da implementação]
...
\subsection{Pipeline}
The pipeline pattern represents the sequential application of multiple operators (or stages) at the same element. Due to having multiple operators, they can be applied in parallel at different elements.
